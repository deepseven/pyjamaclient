...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AbstractitemsApi()
        api_instance.get_abstract_item  # this is an instance of the class Endpoint
        api_instance.get_abstract_item()  # this invokes api_instance.get_abstract_item.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_abstract_item.callable or self.callable in this class
