...
conf = pyjama.Configuration(
    ...
    def __init__(
        ...
        """Constructor
        """
        self._base_path = "http://<jama_endpoint>/rest/latest" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("pyjama")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                "url": "http://<jama_endpoint>/rest/latest",
