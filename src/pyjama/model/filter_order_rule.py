...
class FilterOrderRule(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, direction, field, *args, **kwargs):  # noqa: E501
        """FilterOrderRule - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, direction, field, *args, **kwargs):  # noqa: E501
        """FilterOrderRule - a model defined in OpenAPI
