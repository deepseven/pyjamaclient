...
class CommentLocation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, item, project, *args, **kwargs):  # noqa: E501
        """CommentLocation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, item, project, *args, **kwargs):  # noqa: E501
        """CommentLocation - a model defined in OpenAPI
