...
class WorkflowTransition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, action, new_status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, action, new_status, *args, **kwargs):  # noqa: E501
        """WorkflowTransition - a model defined in OpenAPI
