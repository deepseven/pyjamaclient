...
class ItemTypeWidget(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, synchronize, *args, **kwargs):  # noqa: E501
        """ItemTypeWidget - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, synchronize, *args, **kwargs):  # noqa: E501
        """ItemTypeWidget - a model defined in OpenAPI
