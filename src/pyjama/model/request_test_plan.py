...
class RequestTestPlan(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project, fields, *args, **kwargs):  # noqa: E501
        """RequestTestPlan - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, project, fields, *args, **kwargs):  # noqa: E501
        """RequestTestPlan - a model defined in OpenAPI
